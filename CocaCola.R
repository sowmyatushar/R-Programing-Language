...
library(smooth)
library(readxl)
Cocacola<- read.csv("C:/Users/tussh/Documents/Forecasting/CocaCola_Sales_Rawdata.csv") # read the Walmart data
...
CocacolaData["t"]<- 1:42#creating t
View(CocacolaData)
CocacolaData["log_Sales"]<-log(CocacolaData["Sales"])# creating log of t
CocacolaData["t_square"]<-CocacolaData["t"]*CocacolaData["t"]#Creating Squareroot  of t
attach(CocacolaData)
